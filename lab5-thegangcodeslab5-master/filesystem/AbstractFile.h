...
public:
	...
	enum returnvalues { success, notacomposite, invalidpixel, sizemismatch, unabletoappend, unabletowritedirectory, filealreadyexists, 
		childdoesnotexist, writepermissiondenied };
